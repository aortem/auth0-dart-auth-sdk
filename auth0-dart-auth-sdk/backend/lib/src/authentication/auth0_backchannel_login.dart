...
import '../exceptions/auth0_back_channel_login_exception.dart';
import '../models/auth0_back_channel_login_request_model.dart';
import '../models/auth0_back_channel_login_response_model.dart';
...
/// Example usage:
/// ```dart
/// final loginService = Auth0BackChannelLogin(domain: 'example.auth0.com');
/// try {
...
class Auth0BackChannelLogin {
  ...
  /// Constructor for creating an instance of [Auth0BackChannelLogin].
  ///
  ...
  ///
  /// Returns an [Auth0BackChannelLoginResponse] on successful login.
  ///
  /// Throws [Auth0BackChannelLoginException] if the request fails or if the response is invalid.
  Future<Auth0BackChannelLoginResponse> initiate({
    ...
    final request = Auth0BackChannelLoginRequest(
      clientId: clientId,
      loginHint: loginHint,
      scope: scope,
      acrValues: acrValues,
    ...
    try {
      ...
      if (response.statusCode == 200) {
        return Auth0BackChannelLoginResponse.fromJson(
          jsonDecode(response.body) as Map<String, dynamic>,
        );
      } else {
        // Handle failed response
        throw Auth0BackChannelLoginException(
  ...
  ///
  /// This method should be called when the [Auth0BackChannelLogin] instance
