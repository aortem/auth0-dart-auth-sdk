import 'dart:convert';
import '../models/auth0_social_login_response.dart';
import 'package:ds_standard_features/ds_standard_features.dart' as http;

import '../exceptions/auth0_social_login_exceptions.dart';
import '../models/auth0_social_login_request.dart';
...
class Auth0SocialLogin {
  ...
  /// Constructs an instance of [Auth0SocialLogin].
  ///
  ...
  ///
  /// Returns an [Auth0SocialLoginResponse] upon successful authentication.
  ///
  /// Throws [Auth0SocialLoginException] if the request fails, the response is invalid,
  /// or any other errors occur during the process.
  Future<Auth0SocialLoginResponse> authenticate({
    required String socialAccessToken,
    required String connection,
    String? scope,
    String? audience,
  }) async {
    final request = Auth0SocialLoginRequest(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        return Auth0SocialLoginResponse.fromJson(
          jsonDecode(response.body) as Map<String, dynamic>,
        );
      } else {
        // Handle failed authentication
        throw Auth0SocialLoginException(
  ...
  ///
  /// This method should be called when the [Auth0SocialLogin] instance is no longer needed,
