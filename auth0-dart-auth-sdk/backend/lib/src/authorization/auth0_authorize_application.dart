import '../models/auth0_authorize_application_request_model.dart';

import '../models/auth0_authorize_application_response_model.dart';
...
class Auth0AuthorizeApplicationService {
  ...
  ///
  /// Returns an [Auth0AuthorizeApplicationResponse] containing the constructed URL.
  ///
  /// Example:
  /// ```dart
  /// final response = Auth0AuthorizeApplicationService().buildAuthorizationUrl(
  ///   auth0DomainUri: Uri.parse('https://your-tenant.auth0.com'),
  ///   request: Auth0AuthorizeApplicationRequest(
  ///     clientId: 'abc123',
  ...
  /// ```
  Auth0AuthorizeApplicationResponse buildAuthorizationUrl({
    required Uri auth0DomainUri,
    required Auth0AuthorizeApplicationRequest request,
  }) {
    ...
    return Auth0AuthorizeApplicationResponse(url: uri);
  }
}
