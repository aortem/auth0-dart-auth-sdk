import 'package:auth0_dart_auth_sdk/src/models/auth0_dynamic_application_client_registration_request_model.dart';
import 'package:auth0_dart_auth_sdk/src/models/auth0_dynamic_application_client_registration_response_model.dart';

/// A utility class to build an Auth0 authorization URL.
class Auth0AuthorizeApplicationBuilder {
  /// Constructs the authorization URL based on the provided domain and request parameters.
  static Auth0AuthorizeApplicationClientRegisterResponse build({
    required Uri auth0DomainUri,
    required Auth0AuthorizeApplicationClientRegisterRequest request,
  }) {
    ...
    return Auth0AuthorizeApplicationClientRegisterResponse(url: uri);
  }
}
