...
class Auth0DatabaseAdLdapPassiveException implements Exception {
  ...
  /// Constructs an [Auth0DatabaseAdLdapPassiveException] with the given [message],
  ...
  @override
  String toString() =>
      'Auth0DatabaseAdLdapPassiveException: $message'
