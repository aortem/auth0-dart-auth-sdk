...
/// }
/// ```
class Auth0MultifactorVerifyException implements Exception {
  ...
  ///
  /// Format: "Auth0Exception(statusCode): message"
  /// Example: "Auth0Exception(400): Invalid verification code"
  @override
  String toString() => 'Auth0Exception($statusCode): $message';
}
