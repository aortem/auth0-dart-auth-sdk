import '../models/auth0_logout_request_model.dart';
import '../models/auth0_logout_response_model.dart';
...
/// Example usage:
/// ```dart
/// final logoutService = Auth0Logout(auth0Domain: 'your-domain.auth0.com');
/// final request = Auth0LogoutRequest(clientId: 'your-client-id');
...
class Auth0Logout {
  ...
  ///
  /// Returns an [Auth0LogoutResponse] containing the generated logout URL.
  ///
  /// Throws an [ArgumentError] if `clientId` is not provided.
  Auth0LogoutResponse generateLogoutUrl(Auth0LogoutRequest request) {
    ...
    return Auth0LogoutResponse(logoutUrl: logoutUri.toString());
  }
}
