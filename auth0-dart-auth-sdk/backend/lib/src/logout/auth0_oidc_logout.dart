import 'dart:core';
import 'package:auth0_dart_auth_sdk/src/models/auth0_oidc_logout_request_model.dart';
import 'package:auth0_dart_auth_sdk/src/models/auth0_oidc_logout_response_model.dart';
...
/// Example usage:
/// ```dart
/// final logoutService = Auth0OidcLogout(auth0Domain: 'your-domain.auth0.com');
...
class Auth0OidcLogout {
  ...
  Auth0OidcLogout({required this.auth0Domain}) {
  ...
  ///
  /// Returns:
  /// - [Auth0OidcLogoutResponse] containing the constructed logout URL
  ///
  /// Example URL structure:
  /// `https://[auth0Domain]/v2/logout?client_id=[clientId]&id_token_hint=[token]&post_logout_redirect_uri=[uri]&state=[state]`
  Auth0OidcLogoutResponse generateLogoutUrl(Auth0OidcLogoutRequest request) {
