// lib/src/auth0/saml/auth0_saml_logout.dart

import 'package:auth0_dart_auth_sdk/src/models/auth0_saml_logout_request.dart';
import 'package:auth0_dart_auth_sdk/src/models/auth0_saml_logout_response.dart';
...
/// Example usage:
/// ```dart
/// final logout = Auth0SamlLogout(domain: 'your-tenant.auth0.com');
...
class Auth0SamlLogout {
  ...
  Auth0SamlLogout({required this.domain}) {
  ...
  ///
  /// Takes an [Auth0SamlLogoutRequest] and returns an [Auth0SamlLogoutResponse]
  /// containing the generated logout URL
  Auth0SamlLogoutResponse buildLogoutUrl(Auth0SamlLogoutRequest request) {
    final uri = Uri.https(domain, '/samlp/logout', request.toQueryParams());
    return Auth0SamlLogoutResponse(logoutUrl: uri.toString());
  }
}
