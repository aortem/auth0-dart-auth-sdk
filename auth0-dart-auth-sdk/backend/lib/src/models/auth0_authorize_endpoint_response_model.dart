...
/// as specified in the original [Auth0AuthorizeEndpointRequest].
///
/// Example usage:
/// ```dart
/// final response = Auth0AuthorizeEndpointResponse(authorizationUrl);
...
class Auth0AuthorizeEndpointResponse {
  ...
  Auth0AuthorizeEndpointResponse(this.authorizationUrl);
