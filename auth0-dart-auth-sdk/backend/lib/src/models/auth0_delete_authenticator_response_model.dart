...
class Auth0DeleteAuthenticatorResponse {
  ...
  /// Creates a new [Auth0DeleteAuthenticatorResponse] instance.
  ///
  ...
  /// Parses a JSON map into an [Auth0DeleteAuthenticatorResponse] object.
  ///
  ...
  factory Auth0DeleteAuthenticatorResponse.fromJson(Map<String, dynamic> json) {
