...
/// final response = Auth0EnterpriseSamlResponse.fromHash(window.location.hash);
/// print('Access Token: ${response.accessToken}');
/// ```
class Auth0EnterpriseSamlResponse {
  ...
  /// Returns a structured [Auth0EnterpriseSamlResponse] containing the tokens
  /// Throws [Auth0EnterpriseSamlException] if the hash is empty
  ///
  /// Typical hash format:
  /// #access_token=ABCDEF&token_type=Bearer&id_token=GHIJKL&state=123456
  factory Auth0EnterpriseSamlResponse.fromHash(String urlHash) {
    if (urlHash.isEmpty) {
    ...
    return Auth0EnterpriseSamlResponse(
