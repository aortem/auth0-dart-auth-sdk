...
/// Example usage:
/// ```dart
/// final request = Auth0ListAuthenticatorsRequest(accessToken);
/// ```
class Auth0ListAuthenticatorsRequest {
  ...
  /// Creates a new [Auth0ListAuthenticatorsRequest] instance.
  ///
  ...
  Auth0ListAuthenticatorsRequest(this.accessToken) {
