...
class Auth0UserProfileResponse {
  ...
  /// Constructs an [Auth0UserProfileResponse] with the provided fields.
  ...
  /// Creates an instance of [Auth0UserProfileResponse] from a JSON map.
  ///
  ...
  /// }
  /// ```
  factory Auth0UserProfileResponse.fromJson(Map<String, dynamic> json) {
