...
import '../models/auth0_add_authenticator_request_model.dart';
import 'package:ds_standard_features/ds_standard_features.dart' as http;
import '../models/auth0_add_authenticator_response_model.dart';
...
/// );
/// ```
class Auth0MfaAddAuthenticator {
  ...
  ///
  /// Returns:
  /// A [Future] that resolves to an [Auth0AddAuthenticatorResponse]
  ...
  Future<Auth0AddAuthenticatorResponse> auth0AddAuthenticator(
    Auth0AddAuthenticatorRequest request,
  ) async {
    ...
    if (response.statusCode == 200) {
      try {
        ...
        return Auth0AddAuthenticatorResponse.fromJson(data);
      } catch (e) {
