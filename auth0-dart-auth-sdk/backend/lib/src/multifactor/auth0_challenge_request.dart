...
/// Example Usage:
/// ```dart
/// final challengeService = AuthOMultifactorChallengeRequest(
...
/// );
/// ```
class AuthOMultifactorChallengeRequest {
  ...
  ///
  /// Returns:
  /// A [Future<Auth0ChallengeResponse>] containing:
  ...
  Future<Auth0ChallengeResponse> requestChallenge(
    Auth0ChallengeRequest request,
  ) async {
    ...
    if (response.statusCode == 200) {
      try {
        ...
        return Auth0ChallengeResponse.fromJson(json);
      } catch (e) {
