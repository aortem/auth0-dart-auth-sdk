import 'dart:convert';
import 'package:auth0_dart_auth_sdk/src/exceptions/auth0_multi_factor_verify_exception.dart';
import 'package:auth0_dart_auth_sdk/src/models/auth0_multi_factor_verify_request_model.dart';
import 'package:auth0_dart_auth_sdk/src/models/auth0_multi_factor_verify_response_model.dart';
...
/// Example usage:
/// ```dart
/// final mfaService = Auth0MultiFactorService(
...
class Auth0MultiFactorService {
  ...
  /// Creates an instance of [Auth0MultiFactorService].
  ///
  /// Requires:
  ...
  ///
  /// Returns:
  /// A [Future] that completes with an [Auth0MultiFactorVerifyResponse]
  /// if verification is successful.
  ///
  /// Throws:
  /// - [ArgumentError] if either mfaToken or otp is empty
  /// - [Auth0MultifactorVerifyException] if the verification fails
  /// - [TimeoutException] if the request times out
  /// - Other [Exception] types for network or parsing errors
  Future<Auth0MultiFactorVerifyResponse> verify(
    Auth0MultiFactorVerifyRequest request,
  ) async {
    ...
    if (response.statusCode == 200) {
      ...
      return Auth0MultiFactorVerifyResponse.fromJson(json);
    } else {
      final error = jsonDecode(response.body);
      throw Auth0MultifactorVerifyException(
