...
import '../models/auth0_verify_recovery_code_request_model.dart';
import '../models/auth0_verify_recovery_code_response_model.dart';
...
class Auth0MfaApiClient {
  ...
  Auth0MfaApiClient({required this.auth0Domain, http.Client? httpClient})
  ...
  ///
  /// Returns:
  ///   Future resolving to [Auth0VerifyRecoveryCodeResponse] on success
  ///
  /// Throws:
  ///   [Exception] for non-200 HTTP responses
  ///   [FormatException] for invalid JSON responses
  Future<Auth0VerifyRecoveryCodeResponse> verifyRecoveryCode(
    Auth0VerifyRecoveryCodeRequest request,
  ) async {
    ...
    try {
      ...
      return Auth0VerifyRecoveryCodeResponse.fromJson(jsonBody);
    } catch (e) {
