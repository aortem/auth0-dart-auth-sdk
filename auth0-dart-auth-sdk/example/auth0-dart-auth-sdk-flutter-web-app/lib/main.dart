...
import 'package:auth0_dart_auth_sdk_flutter_test_app/screens/AuthLoginuserpage.dart';
...
import 'package:auth0_dart_auth_sdk_flutter_test_app/screens/MultiFactorVerifyTestScreen.dart';
import 'package:auth0_dart_auth_sdk_flutter_test_app/screens/OidcLogoutGeneratorPage.dart';
import 'package:auth0_dart_auth_sdk_flutter_test_app/screens/OobVerifyScreen_tests.dart';
import 'package:auth0_dart_auth_sdk_flutter_test_app/screens/PasswordlessTestApp.dart';
import 'package:auth0_dart_auth_sdk_flutter_test_app/screens/SamlLogoutTestApp.dart';
import 'package:auth0_dart_auth_sdk_flutter_test_app/screens/TokenRevocationSampleUI.dart';
import 'package:auth0_dart_auth_sdk_flutter_test_app/screens/auth0_passive_login_screen.dart';
...
import 'package:auth0_dart_auth_sdk_flutter_test_app/screens/backChannelLoginTest.dart';
import 'package:auth0_dart_auth_sdk_flutter_test_app/screens/getUser_info.dart';
...
import 'package:auth0_dart_auth_sdk_flutter_test_app/screens/saml_test_screen.dart';
            ...
            TextButton(
              onPressed: () {
                Navigator.push(
                  ...
                  MaterialPageRoute<void>(
                    builder: (BuildContext context) =>
                        const Auth0LogoutTestScreen(),
                  ),
                );
              },
              child: const Text('Auth0Logout'),
            ),
            TextButton(
              onPressed: () {
                Navigator.push(
                  ...
                  MaterialPageRoute<void>(
                    builder: (BuildContext context) =>
                        const SamlLogoutTestApp(),
                  ),
                );
              },
              child: const Text('Auth0SamlLogout'),
            ),
            TextButton(
              onPressed: () {
                Navigator.push(
                  ...
                  MaterialPageRoute<void>(
                    builder: (BuildContext context) =>
                        OidcLogoutGeneratorPage(),
                  ),
                );
              },
              child: const Text('Auth0OidcLogout'),
            ),
            TextButton(
              onPressed: () {
                Navigator.push(
                  ...
                  MaterialPageRoute<void>(
                    builder: (BuildContext context) =>
                        TokenRevocationSampleUI(),
                  ),
                );
              },
              child: const Text('Auth0GlobalTokenRevocation'),
            ),
            TextButton(
              onPressed: () {
                Navigator.push(
            ...
            TextButton(
              onPressed: () {
                Navigator.push(
                  ...
                  MaterialPageRoute<void>(
                    builder: (BuildContext context) =>
                        const MultiFactorVerifyTestScreen(),
                  ),
                );
              },
              child: const Text('Auth0MultiFactorVerify '),
            ),
            TextButton(
              onPressed: () {
                Navigator.push(
            ...
            TextButton(
              onPressed: () {
                Navigator.push(
                  ...
                  MaterialPageRoute<void>(
                    builder: (BuildContext context) =>
                        Auth0PassiveLoginScreen(),
                  ),
                );
              },
              child: const Text('Auth0DatabaseAdLdapPassive'),
            ),
            TextButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute<void>(
                    builder: (BuildContext context) => SamlTestScreen(),
                  ),
                );
              },
              child: const Text('Auth0EnterpriseSaml'),
            ),
            ...
            TextButton(
              onPressed: () {
                Navigator.push(
                  ...
                  MaterialPageRoute<void>(
                    builder: (BuildContext context) =>
                        BackChannelLoginTestScreen(),
                  ),
                );
              },
              child: const Text('Auth0BackChannelLogin'),
            ),
            TextButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute<void>(
                    builder: (BuildContext context) => PasswordlessTestApp(),
                  ),
                );
              },
              child: const Text('Auth0GetCodeOrLink '),
            ),
            TextButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute<void>(
                    builder: (BuildContext context) => Auth0LoginPage(),
                  ),
                );
              },
              child: const Text('Auth0AuthenticateUser '),
            ),
            TextButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute<void>(
                    builder: (BuildContext context) => GetUserInfoTestScreen(),
                  ),
                );
              },
              child: const Text('Auth0GetUserInfo'),
            ),
          ],
        ),
      ),
