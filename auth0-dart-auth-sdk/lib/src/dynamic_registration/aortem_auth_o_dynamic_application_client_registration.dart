...
class AortemAuth0AuthorizeApplicationBuilder {
  ...
  static AortemAuth0AuthorizeApplicationClientRegisterResponse build({
    required Uri auth0DomainUri,
    required AortemAuth0AuthorizeApplicationClientRegisterRequest request,
  }) {
    ...
    return AortemAuth0AuthorizeApplicationClientRegisterResponse(url: uri);
  }
}
