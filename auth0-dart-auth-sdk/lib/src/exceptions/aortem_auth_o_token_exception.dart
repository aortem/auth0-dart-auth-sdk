...
class AortemAuth0TokenException implements Exception {
  ...
  AortemAuth0TokenException(this.message, [this.statusCode]);

  @override
  String toString() => 'AortemAuth0TokenException ($statusCode): $message';
}
