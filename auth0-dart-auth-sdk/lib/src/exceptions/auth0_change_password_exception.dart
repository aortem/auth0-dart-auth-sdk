...
///
/// This exception is typically thrown by [Auth0ChangePassword] when:
...
/// - JSON parsing errors
class Auth0ChangePasswordException implements Exception {
  ...
  /// Creates an [Auth0ChangePasswordException] with the given error message.
  ///
  /// [message]: The detailed error description (required).
  Auth0ChangePasswordException(this.message);
  ...
  @override
  String toString() {
    return 'Auth0ChangePasswordException: $message';
  }
}
