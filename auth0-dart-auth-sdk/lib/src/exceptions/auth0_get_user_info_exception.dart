...
/// } on Auth0UserInfoException catch (e) {
...
class Auth0UserInfoException implements Exception {
  ...
  Auth0UserInfoException(this.message, [this.statusCode]);

  @override
  String toString() => 'Auth0UserInfoException($statusCode): $message';
}
