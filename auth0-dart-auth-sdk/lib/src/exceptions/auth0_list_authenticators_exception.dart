...
/// } on Auth0ListAuthenticatorsException catch (e) {
///   print('Failed to list authenticators: ${e.message}');
///   // Handle specific error case
/// }
/// ```
class Auth0ListAuthenticatorsException implements Exception {
  ...
  @override
  String toString() => 'Auth0ListAuthenticatorsException: $message';
}
