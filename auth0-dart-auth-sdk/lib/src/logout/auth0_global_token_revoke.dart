import 'package:auth0_dart_auth_sdk/src/models/auth0_global_token_revocation_request.dart';
import 'package:auth0_dart_auth_sdk/src/models/auth0_global_token_revocation_response.dart';
...
/// Example usage:
/// ```dart
/// final tokenRevocationService = Auth0GlobalTokenRevocation(domain: 'your-domain.auth0.com');
/// final request = Auth0GlobalTokenRevocationRequest(token: 'your-token');
/// try {
...
/// }
/// ```
class Auth0GlobalTokenRevocation {
  /// The Auth0 domain.
  ///
  ...
  ///
  /// Returns an [Auth0GlobalTokenRevocationResponse] indicating whether the revocation was successful.
  ///
  /// Throws an [Exception] if the revocation fails or the response is not successful.
  Future<Auth0GlobalTokenRevocationResponse> revokeToken({
    required Auth0GlobalTokenRevocationRequest request,
  }) async {
    ...
    if (response.statusCode == 200) {
      ...
      return Auth0GlobalTokenRevocationResponse(success: true);
    } else {
