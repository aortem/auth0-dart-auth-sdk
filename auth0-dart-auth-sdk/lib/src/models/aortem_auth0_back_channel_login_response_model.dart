...
class AortemAuth0BackChannelLoginResponse {
  ...
  /// Creates an [AortemAuth0BackChannelLoginResponse] with the given
  /// [authReqId], [expiresIn], and optional [interval].
  AortemAuth0BackChannelLoginResponse({
    required this.authReqId,
    required this.expiresIn,
    this.interval,
  });

  /// Creates an instance of [AortemAuth0BackChannelLoginResponse] from a JSON map.
  ///
  ...
  factory AortemAuth0BackChannelLoginResponse.fromJson(
    ...
    return AortemAuth0BackChannelLoginResponse(
