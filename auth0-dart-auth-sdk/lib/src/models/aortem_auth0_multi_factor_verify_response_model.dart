...
/// Example usage:
/// ```dart
/// final response = AortemAuth0MultiFactorVerifyResponse.fromJson(jsonData);
/// print('Access Token: ${response.accessToken}');
/// print('ID Token: ${response.idToken}');
/// ```
class AortemAuth0MultiFactorVerifyResponse {
  ...
  /// Parses a JSON map into an [AortemAuth0MultiFactorVerifyResponse] instance.
  ///
