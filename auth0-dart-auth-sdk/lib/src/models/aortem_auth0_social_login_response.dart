...
class AortemAuth0SocialLoginResponse {
  ...
  ///constructure
  AortemAuth0SocialLoginResponse({
  ...
  factory AortemAuth0SocialLoginResponse.fromJson(Map<String, dynamic> json) {
    ...
    return AortemAuth0SocialLoginResponse(
