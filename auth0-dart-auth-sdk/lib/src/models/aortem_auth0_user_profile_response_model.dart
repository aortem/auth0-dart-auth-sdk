...
class AortemAuth0UserProfileRequest {
  /// The access token used to authorize the request.
  final String accessToken;

  /// Constructs an [AortemAuth0UserProfileRequest] with the given [accessToken].
  ///
  /// Throws an [ArgumentError] if the access token is empty.
  AortemAuth0UserProfileRequest({required this.accessToken}) {
