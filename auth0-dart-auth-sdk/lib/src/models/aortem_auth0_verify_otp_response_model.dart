...
/// }
/// ```
class AortemAuth0VerifyOTPResponse {
  ...
  /// Constructs a new [AortemAuth0VerifyOTPResponse].
  AortemAuth0VerifyOTPResponse({
  ...
  /// Creates an instance of [AortemAuth0VerifyOTPResponse] from a JSON map.
  factory AortemAuth0VerifyOTPResponse.fromJson(Map<String, dynamic> json) {
    return AortemAuth0VerifyOTPResponse(
