...
class Auth0ChangePasswordResponse {
  ...
  /// Creates an [Auth0ChangePasswordResponse] instance.
  ///
  /// [message]: The response message from Auth0 (required).
  Auth0ChangePasswordResponse({required this.message});

  /// Constructs an [Auth0ChangePasswordResponse] from a JSON map.
  ///
  ...
  /// Returns an [Auth0ChangePasswordResponse] with the parsed message.
  /// If 'message' field is missing in JSON, defaults to 'No message received'.
  factory Auth0ChangePasswordResponse.fromJson(Map<String, dynamic> json) {
    return Auth0ChangePasswordResponse(
