...
class Auth0GetCodeOrLinkResponse {
  ...
  /// Constructs an [Auth0GetCodeOrLinkResponse] with the given [success] status
  /// and [message].
  Auth0GetCodeOrLinkResponse({required this.success, required this.message});
}
