...
/// Example usage:
/// ```dart
/// final response = Auth0GetTokenResponse.fromJson(jsonData);
/// print('Access Token: ${response.accessToken}');
/// if (response.idToken != null) {
///   print('ID Token: ${response.idToken}');
/// }
/// ```
class Auth0GetTokenResponse {
  ...
  factory Auth0GetTokenResponse.fromJson(Map<String, dynamic> json) {
    return Auth0GetTokenResponse(
