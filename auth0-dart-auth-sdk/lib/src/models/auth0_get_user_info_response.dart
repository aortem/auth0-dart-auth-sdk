...
/// Example:
/// ```dart
/// final userInfo = Auth0GetUserInfoResponse.fromJson(responseData);
/// print('User ID: ${userInfo.sub}');
/// print('Email: ${userInfo.email}');
/// ```
class Auth0GetUserInfoResponse {
  ...
  /// Creates an [Auth0GetUserInfoResponse] instance.
  ///
  ...
  /// Parses a JSON map into an [Auth0GetUserInfoResponse] instance.
  ///
  ...
  /// - [json] is not a valid Map
  factory Auth0GetUserInfoResponse.fromJson(Map<String, dynamic> json) {
    return Auth0GetUserInfoResponse(
