...
class Auth0VerifyRecoveryCodeResponse {
  ...
  Auth0VerifyRecoveryCodeResponse({
  ...
  ///
  /// Returns:
  ///   New [Auth0VerifyRecoveryCodeResponse] instance
  ///
  ...
  /// }
  factory Auth0VerifyRecoveryCodeResponse.fromJson(Map<String, dynamic> json) {
    return Auth0VerifyRecoveryCodeResponse(
