...
/// Example usage:
/// ```dart
/// final client = Auth0DeleteAuthenticatorClient(auth0Domain: 'your-domain.auth0.com');
/// final response = await client.deleteAuthenticator(request);
/// ```
class Auth0DeleteAuthenticatorClient {
  ...
  ///
  /// Returns a [Future] that completes with an [Auth0DeleteAuthenticatorResponse]
  /// indicating the result of the operation.
  ///
  /// Throws:
  /// - [ArgumentError] if required parameters are missing or empty
  /// - [Auth0DeleteAuthenticatorException] if the API request fails
  ...
  Future<Auth0DeleteAuthenticatorResponse> deleteAuthenticator(
    Auth0DeleteAuthenticatorRequest request,
  ) async {
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 204) {
        if (response.body.isNotEmpty) {
          ...
          return Auth0DeleteAuthenticatorResponse.fromJson(responseJson);
        } else {
          // Return success response for empty responses
          return Auth0DeleteAuthenticatorResponse(
        ...
        throw Auth0DeleteAuthenticatorException(
