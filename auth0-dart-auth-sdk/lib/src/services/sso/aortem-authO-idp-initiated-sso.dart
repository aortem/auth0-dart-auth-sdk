...
class AortemAuth0IdpInitiatedSSOFlowRequest {
  ...
  AortemAuth0IdpInitiatedSSOFlowRequest({
...
class AortemAuth0IdpInitiatedSSOFlowResponse {
  ...
  AortemAuth0IdpInitiatedSSOFlowResponse(this.ssoUrl);
}
...
///
/// Returns [AortemAuth0IdpInitiatedSSOFlowResponse] containing the constructed URL.
///
/// Throws [Exception] if URL construction fails for any reason.
AortemAuth0IdpInitiatedSSOFlowResponse aortemAuth0IdpInitiatedSSOFlow({
  required Uri auth0DomainUri,
  required AortemAuth0IdpInitiatedSSOFlowRequest request,
}) {
  try {
    ...
    return AortemAuth0IdpInitiatedSSOFlowResponse(uri);
  } catch (e) {
