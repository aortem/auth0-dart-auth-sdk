import 'package:auth0_dart_auth_sdk/src/models/auth0_back_channel_login_request_model.dart';
import 'package:auth0_dart_auth_sdk/src/models/auth0_back_channel_login_response_model.dart';
import 'package:auth0_dart_auth_sdk/src/authentication/auth0_backchannel_login.dart';
...
void main() {
  ...
  late Auth0BackChannelLogin backChannelLogin;
  const domain = 'test.auth0.com';

  setUp(() {
    mockClient = MockClient();
    backChannelLogin = Auth0BackChannelLogin(
      domain: domain,
  ...
  group('Response Model', () {
    test('parses successful response', () {
      final response = Auth0BackChannelLoginResponse.fromJson({
    ...
    test('throws FormatException for invalid response', () {
      expect(
        () => Auth0BackChannelLoginResponse.fromJson({'expires_in': 300}),
