...
void main() {
  group('Auth0GetMetadata40', () {
    ...
    test('returns metadata on success (200)', () async {
      ...
      final request = Auth0GetMetadata40Request(accessToken: 'test-token');
    ...
    test('throws on unauthorized (401)', () async {
      ...
      final request = Auth0GetMetadata40Request(accessToken: 'invalid-token');

      expect(
        () async => await auth0GetMetadata40(
          auth0DomainUri: auth0DomainUri,
          request: request,
          client: mockClient,
        ),
    ...
    test('throws ArgumentError for empty accessToken', () {
      expect(
        () => Auth0GetMetadata40Request(accessToken: ''),
