import 'package:auth0_dart_auth_sdk/src/models/aortem-auth0-authorize-endpoint_request_model.dart';
import 'package:auth0_dart_auth_sdk/src/models/aortem-auth0-authorize-endpoint_response_model.dart';
import 'package:auth0_dart_auth_sdk/src/services/authorization/aortem-authO-authorize-endpoint.dart';
...
void main() {
  group('AortemAuth0AuthorizeEndpoint', () {
    ...
    test('throws ArgumentError when required fields are missing in request',
        () {
      final endpoint = AortemAuth0AuthorizeEndpoint(auth0DomainUri: domainUri);
    ...
    test(
      ...
      expect(response.url.queryParameters['redirect_uri'],
    ...
    test('returns AortemAuth0AuthorizeEndpointResponse with all parameters',
        () {
      final endpoint = AortemAuth0AuthorizeEndpoint(auth0DomainUri: domainUri);
