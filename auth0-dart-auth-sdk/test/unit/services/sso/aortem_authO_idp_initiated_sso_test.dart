import 'package:auth0_dart_auth_sdk/src/services/sso/aortem-authO-idp-initiated-sso.dart';
...
void main() {
  group('AortemAuth0IdpInitiatedSSOFlow', () {
    ...
    test('should create a valid SSO URL with only required parameters', () {
      ...
      expect(
          response.ssoUrl.queryParameters.containsKey('redirect_uri'), isFalse);
      expect(
          response.ssoUrl.queryParameters.containsKey('connection'), isFalse);
    ...
    test('should create a valid SSO URL with all parameters', () {
      ...
      expect(response.ssoUrl.path, '/login');
      expect(response.ssoUrl.queryParameters['client'], 'abc123');
      expect(response.ssoUrl.queryParameters['redirect_uri'],
