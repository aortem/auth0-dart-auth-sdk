...
import 'package:auth0_dart_auth_sdk/src/services/user/aortem-authO-get-user-info.dart';
...
void main() {
  group('aortemAuth0GetUserInfo', () {
    ...
    test('returns valid user info response when API returns 200', () async {
      ...
      final request =
          AortemAuth0GetUserInfoRequest(accessToken: testAccessToken);
    ...
    test('throws ArgumentError when access token is empty', () {
      expect(() => AortemAuth0GetUserInfoRequest(accessToken: ''),
